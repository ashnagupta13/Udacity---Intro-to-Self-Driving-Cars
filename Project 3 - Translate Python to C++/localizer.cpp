...
vector< vector <float> > initialize_beliefs(vector< vector <char> > grid) {
  	...
  	// Assigning the initial belief to each cell in newGrid
	...
	float p_miss) 
{
	// Initializing variables
  	...
  	// Looping through the grid to check the color of the cell.
  	// If color matches the requirement, alter the inital belief accordingly.
  	for(int i = 0; i < height; i++)
    {
      for(int j = 0; j < width; j++)
      {
